...
//                 //TODO verify that the secret key of the client matches their secret key on file
...
//                 // Encrypt the secret key using the client's hashed password
//                 byte[] encryptedSecretKey = encryptSecretKey(secretKey, password); 

//                 // Create MAC for the encrypted secret key
//                 byte[] mac = MACUtils.createMAC(encryptedSecretKey, password); 

//                 // Send both encrypted secret key and MAC to client
